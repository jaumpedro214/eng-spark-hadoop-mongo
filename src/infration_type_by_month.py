...
# Contar o número de infrações de cada tipo por mês e ano
df_infracoes = (
    df_infracoes
    .select(
        # convert to date
...
df_infracoes.write.format("com.mongodb.spark.sql.DefaultSource") \
    ...
    .option("collection", "gravidade_mes") \
    .save()

# Command to run
# spark-submit --packages org.mongodb.spark:mongo-spark-connector_2.12:3.0.1 /src/infration_type_by_month.py