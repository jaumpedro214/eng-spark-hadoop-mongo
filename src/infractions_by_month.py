...
MONGODB_COLLECTION = "contagem_mes"
...
# Contagem de acidentes por mes
df_infracoes = df_infracoes.withColumn(
    "mes",
    # Regex pattern to extract the month
...
# Command to run
# spark-submit --packages org.mongodb.spark:mongo-spark-connector_2.12:3.0.1 /src/infractions_by_month.py